...
const REPO_URL: string = 'https://github.com/Machi/MokaCode-Quentinho.git';
const DEFAULT_BRANCH: string = 'master';

function printUsage(): void {
    console.log(`
☕ Uso: moka-install [blend] <nome-do-projeto>
...
Cardápio de Exemplos:
  moka-install meu-novo-jogo                 (cria um projeto a partir do 'bodyless')
  moka-install platformer meu-jogo-plataforma
  moka-install topdown meu-rpg-descafeinado
    `);
    process.exit(0);
}
